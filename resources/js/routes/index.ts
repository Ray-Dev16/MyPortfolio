 ...
 */
    ...
    home.form = homeForm
/**
* @see \App\Http\Controllers\WelcomeController::techStack
 * @see app/Http/Controllers/WelcomeController.php:108
 * @route '/tech-stack'
 */
export const techStack = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: techStack.url(options),
    method: 'get',
})
 ...
 * @route '/tech-stack'
 */
techStack.url = (options?: RouteQueryOptions) => {
    return techStack.definition.url + queryParams(options)
}
 ...
 * @route '/tech-stack'
 */
techStack.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: techStack.url(options),
    method: 'get',
})
/**
 ...
 * @route '/tech-stack'
 */
techStack.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: techStack.url(options),
    method: 'head',
})
 ...
 * @route '/tech-stack'
 */
    const techStackForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: techStack.url(options),
        method: 'get',
    })
 ...
 * @route '/tech-stack'
 */
        techStackForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: techStack.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/tech-stack'
 */
        techStackForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: techStack.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    techStack.form = techStackForm
/**
* @see \App\Http\Controllers\WelcomeController::projects
